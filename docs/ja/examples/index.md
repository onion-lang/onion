...
- [Hello World](basic.md#hello-world) - シンプルな出力
- [配列](basic.md#配列) - 配列操作
- [ユーザー入力](basic.md#ユーザー入力) - 入力の読み込み

### オブジェクト指向の例

- [クラスとオブジェクト](oop.md#クラスとオブジェクト) - 基本的なOOP
- [継承](oop.md#継承) - クラスの拡張
- [インターフェース](oop.md#インターフェース) - インターフェースの実装

### 関数型プログラミング

- [ラムダ式](functional.md#ラムダ式) - 無名関数
- [クロージャ](functional.md#クロージャ) - 変数のキャプチャ
- [再帰](functional.md#再帰) - 再帰的アルゴリズム
