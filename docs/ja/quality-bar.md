...
| 3 | 大規模プログラム | 100行以上の `run/*.on` をそのまま end-to-end で実行できる数 | 19（BankLedger、Blackjack、BrokenLogDemo、BudgetTracker、GradeBook、GraphSearch、Inventory、LibraryCatalog、LibrarySystem、MiniRpg、OrderReport、PayrollReport、PlaylistManager、ShapeProcessor、StatsApp、TextAnalyzer、TodoManager、ToolDemo、TournamentTracker） | ≥ 5 |
