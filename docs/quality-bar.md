...
| 3 | Large programs | count of `run/*.on` ≥ 100 lines that run end-to-end as-is | 250 (see `run/` for the full, alphabetized list — no longer enumerated here, see note below) | ≥ 5 |
