...
| 3 | Large programs | count of `run/*.on` ≥ 100 lines that run end-to-end as-is | 8 (BrokenLogDemo, OrderReport, RecipeBook, ShapeProcessor, StatsApp, TextAnalyzer, TodoManager, ToolDemo) | ≥ 5 |
