...
| # | Dimension | How to measure | Current (2026-08-29) | Pass threshold |
|---|-----------|----------------|----------------------|----------------|
| 1 | Test suite | `sbt shutdown && sbt -Duser.language=en testFull` (see the note below) | 4361 pass / 0 fail / 1 cancelled | 0 failed, 0 skipped |
